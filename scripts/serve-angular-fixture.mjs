...
const fixtureRoot = resolve(repositoryRoot, 'fixtures/angular')
const govukRoot = resolve(repositoryRoot, 'node_modules/govuk-frontend/dist/govuk')
const port = Number.parseInt(process.env.GOVUK_ANGULAR_FIXTURE_PORT ?? '4175', 10)
...
if (!Number.isInteger(port) || port < 1 || port > 65_535) {
  throw new Error('GOVUK_ANGULAR_FIXTURE_PORT must be an integer from 1 to 65535.')
}
...
server.listen(port, '127.0.0.1', () => {
  console.log('Angular fixture available at http://127.0.0.1:' + port)
})
