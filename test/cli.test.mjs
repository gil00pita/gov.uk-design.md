...
test('init installs only explicitly selected framework, UI-framework and AI adapters', async () => {
  ...
  assert.ok(await readFile(resolve(target, 'frameworks/astro/DESIGN.md'), 'utf8'))
...
test('adapter selection rejects unknown IDs before installation', async () => {
  ...
  assert.match(result.stderr, /available: html-css, react, angular, svelte, astro, all, none/)
